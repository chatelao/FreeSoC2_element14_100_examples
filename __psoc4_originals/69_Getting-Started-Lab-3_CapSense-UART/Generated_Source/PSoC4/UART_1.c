...
/* Stores internal component configuration for unconfigured mode */
    ...
    /* Common config vars */
    volatile uint8 UART_1_scbMode = UART_1_SCB_MODE_UNCONFIG;
    volatile uint8 UART_1_scbEnableWake;

    /* I2C config vars */
    volatile uint8 UART_1_mode;
    volatile uint8 UART_1_acceptAddr;

    /* SPI/UART config vars */
    volatile uint8 * UART_1_rxBuffer;
    volatile uint8   UART_1_rxDataBits;
    volatile uint32  UART_1_rxBufferSize;

    volatile uint8 * UART_1_txBuffer;
    volatile uint8   UART_1_txDataBits;
    volatile uint32  UART_1_txBufferSize;
