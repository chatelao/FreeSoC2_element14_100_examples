    ...
    *******************************************************************************/
    void UART_1_UartInit(const UART_1_UART_INIT_STRUCT *config)
    {
        ...
        else
        {
            ...
            UART_1_SCB_IRQ_StartEx(&UART_1_SPI_UART_ISR);
    ...
    *******************************************************************************/
    void UART_1_UartInit(void)
    {
        ...
        UART_1_INTR_TX_MASK_REG     = UART_1_UART_DEFAULT_INTR_TX_MASK;
            ...
            #if(UART_1_UART_INTERRUPT_DISABLE)
                UART_1_SCB_IRQ_Disable();
            #endif /* (UART_1_UART_INTERRUPT_DISABLE) */
...
{
    #if(UART_1_CHECK_UART_WAKE_ENABLE)
    {
        UART_1_backup.enableState = 0u; /* Keep SCB enabled */
