...
#define UART_1_SPI_INTERRUPT_ENABLE   ((UART_1_SPI_INTERRUPT_MODE == \
                                                    UART_1_SCB_INTR_MODE_INTERNAL) ? (1u) : (0u))

/* Enable UART mode interrupt */
#define UART_1_UART_INTERRUPT_ENABLE  ((UART_1_UART_INTERRUPT_MODE == \
                                                    UART_1_SCB_INTR_MODE_INTERNAL) ? (1u) : (0u))
    ...
    #define UART_1_CHECK_UART_WAKE_ENABLE (0u != UART_1_scbEnableWake)
    ...
    /* Get wakeup enable option */
    #define UART_1_CHECK_SPI_WAKE_ENABLE  (0u != UART_1_SPI_WAKE_ENABLE)
    #define UART_1_CHECK_UART_WAKE_ENABLE (0u != UART_1_UART_WAKE_ENABLE)
...
***************************************/
    ...
    /* Interrupt sources */
    #define UART_1_SPI_INTERRUPT_DISABLE          (0u == UART_1_SPI_INTERRUPT_ENABLE)
...
***************************************/
    ...
    /* Interrupt sources */
    #define UART_1_UART_INTERRUPT_DISABLE         (0u == UART_1_UART_INTERRUPT_ENABLE)
