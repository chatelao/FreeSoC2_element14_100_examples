...
extern UART_1_BACKUP_STRUCT UART_1_backup;
    ...
    /* Common config vars */
    extern volatile uint8 UART_1_scbMode;
    extern volatile uint8 UART_1_scbEnableWake;

    /* I2C config vars */
    extern volatile uint8 UART_1_mode;
    extern volatile uint8 UART_1_acceptAddr;

    /* SPI/UART config vars */
    extern volatile uint8 * UART_1_rxBuffer;
    extern volatile uint8   UART_1_rxDataBits;
    extern volatile uint32  UART_1_rxBufferSize;

    extern volatile uint8 * UART_1_txBuffer;
    extern volatile uint8   UART_1_txDataBits;
    extern volatile uint32  UART_1_txBufferSize;
