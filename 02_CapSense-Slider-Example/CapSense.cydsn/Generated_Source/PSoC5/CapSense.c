...
uint8 CYXDATA * const CYCODE CapSense_pcTable[] = {
    ...
    (uint8 CYXDATA *)CapSense_PortCH0__LinearSlider0_e5__LS__PC, 
    (uint8 CYXDATA *)CapSense_PortCH0__LinearSlider0_e6__LS__PC, 
    (uint8 CYXDATA *)CapSense_PortCH0__LinearSlider0_e7__LS__PC, 
};
...
const uint8 CYCODE CapSense_portTable[] = {
    ...
    CapSense_PortCH0__LinearSlider0_e5__LS__PORT, 
    CapSense_PortCH0__LinearSlider0_e6__LS__PORT, 
    CapSense_PortCH0__LinearSlider0_e7__LS__PORT, 
};
...
const uint8 CYCODE CapSense_maskTable[] = {
    ...
    CapSense_PortCH0__LinearSlider0_e5__LS__MASK,
    CapSense_PortCH0__LinearSlider0_e6__LS__MASK,
    CapSense_PortCH0__LinearSlider0_e7__LS__MASK,
};
