...
/* Trigger modes */
#define PWM_TRIG_RISING                    (PWM__TRIG_RISING)
#define PWM_TRIG_FALLING                   (PWM__TRIG_FALLING)
#define PWM_TRIG_BOTH                      (PWM__TRIG_BOTH)
#define PWM_TRIG_LEVEL                     (PWM__TRIG_LEVEL)

/* Interrupt mask */
#define PWM_INTR_MASK_TC                   (PWM__INTR_MASK_TC)
#define PWM_INTR_MASK_CC_MATCH             (PWM__INTR_MASK_CC_MATCH)
