...
void CapSense_SetAllSensorsDriveMode(uint8 mode) 
{
    ...
    CyPins_SetPinDriveMode(CapSense_PortCH0__LinearSlider0_e5__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LinearSlider0_e6__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LinearSlider0_e7__LS, mode);
